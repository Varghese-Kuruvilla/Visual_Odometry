...
for seq_no in range(0, 9):
  ...
  for numpyseed in numpyseeds:
    ...
    images_directory = "/home/olorin/Desktop/IISc/OdometryProject/ParkingSpot/data/feb27/data/homography/all_sequences/%02d"%(seq_no)
    ...
    for index, file_path in enumerate(sorted(glob.glob(images_directory + "/left*"))[start_no::5]):
        ...
        seg_img = cv2.imread('/home/olorin/Downloads/tempdownload/outfolder (67)/SEGIMG_%d.jpg'%seq_no, 0)
